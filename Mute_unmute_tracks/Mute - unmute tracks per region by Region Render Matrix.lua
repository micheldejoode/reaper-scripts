 ...
 * @about Regions are a very powerfull tool in Reaper, especially when used with the SWS Region Playlist. 
...
Tip: it works best by disabling the setting in Options --> Audio --> Mute/Solo  "Do not process muted tracks". If not, you can hear some distortion on switching regions while playing.
